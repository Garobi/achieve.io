    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(authorize -> authorize
                ...
                .requestMatchers(HttpMethod.POST, "/platforms").hasAnyRole("ADMIN", "OWNER")
                .requestMatchers(HttpMethod.PUT, "/platforms/**").hasAnyRole("ADMIN", "OWNER")
                .requestMatchers(HttpMethod.DELETE, "/platforms/**").hasAnyRole("ADMIN", "OWNER")
                ...
                .requestMatchers(HttpMethod.PUT, "/achievements/**").hasAnyRole("ADMIN", "OWNER")
                .requestMatchers(HttpMethod.DELETE, "/achievements/**").hasAnyRole("ADMIN", "OWNER")
                .requestMatchers(HttpMethod.POST, "/challenges").hasAnyRole("USER", "ADMIN", "OWNER")
                .requestMatchers(HttpMethod.PUT, "/challenges/**").hasAnyRole("ADMIN", "OWNER")
                .requestMatchers(HttpMethod.DELETE, "/challenges/**").hasAnyRole("ADMIN", "OWNER")
